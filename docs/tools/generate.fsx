...
let website = "" // empty for local testing. Replace with "/FSharp.Text.Experimental.Transform"

let githubLink = "http://github.com/aastevenson/FSharp.Text.Experimental.Transform"

// Specify more information about your project
let info =
  [ "project-name", "FSharp.Text.Experimental.Transform"
    "project-author", "Andrew Stevenson"
    "project-summary", "A library used to parse and transform structured text"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSharp.Text.Experimental.Transform" ]
